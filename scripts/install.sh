...
ufw allow ssh
ufw allow 53/tcp    # DNS for Pi-hole
ufw allow 53/udp    # DNS for Pi-hole
...
echo "  - Pi-hole DNS: $(hostname -I | awk '{print $1}')"
echo ""
echo "📝 Next steps:"
...
echo "  5. Set your device's DNS to $(hostname -I | awk '{print $1}') to use Pi-hole ad blocking"
echo "  6. Customize services in docker-compose.yml as needed"
echo "  7. Set up automatic updates with 'sudo systemctl enable --now servicepi-update.timer'"
echo ""
